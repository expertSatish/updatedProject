<div class="AccountMenu">
    ...
    <ul id="AccountMenu" class="collapse">
        ...
        <li {{in_array(Request::segment(2),['schedules','reschedules'])?'class=active':''}}><a href="#mycalls" class="collapsed" data-bs-toggle="collapse" aria-expanded="false" aria-controls="mycalls"><span><i class="fal fa-phone-rotary me-1"></i> My Calls</span> <i class="fal fa-chevron-down arrow"></i></a>
