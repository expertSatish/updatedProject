                        ...
                        <div class="card-body">
                            ...
                            <div class="utext">
                                <div class="row align-items-center">
                                    <div class="col-md-4 Uinfo">
                                        <small class="text-secondary">Hello,</small>
                                        <h3 class="h5 mb-1">{{userinfo()->name ?? ''}}</h3>
                                        <a href="{{route('user.account')}}"><i class="fal fa-edit"></i> Edit Account</a>  
                                        @if(userinfo()->complete_profile==0)
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-md-3 col-sm-4 col-6">
                                    <a href="{{route('user.schedules')}}?type=newcalls" class="card UserBox TopBoxs mb-4">
                                        <div class="card-body">
                                            <i class="fal fa-phone-plus thm2 h1"></i>
                                            <h3 class="h2 m-0 thm">{{\App\Models\SlotBook::where(['user_id'=>userinfo()->id])->whereIn('payment', [1,3])->where('booking_time','>=',date('Y-m-d H:i:s'))->count()}}</h3>
                                            <p class="m-0 text-secondary"><small>New Call Requests</small></p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-3 col-sm-4 col-6">
                                    <a href="{{route('user.schedules')}}?type=callhistory" class="card UserBox TopBoxs mb-4">
                                        <div class="card-body">
                                            <i class="fal fa-phone-alt thm2 h1"></i>
                                            <h3 class="h2 m-0 thm">{{\App\Models\SlotBook::where(['user_id'=>userinfo()->id])->whereIn('status', [1,2,3])->count()}}</h3>
                                            <p class="m-0 text-secondary"><small>Call History</small></p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-3 col-sm-4 col-6">
                                    <a href="{{route('user.message')}}" class="card UserBox TopBoxs mb-4">
                                        <div class="card-body">
                                            <i class="fal fa-comment-alt-lines thm2 h1"></i>
                                            <h3 class="h2 m-0 thm">
                                                {{\App\Models\ComposeMessage::where('user_id',userinfo()->id)->where(['archive_to'=>0,'delete_to'=>0,'send_by'=>1,'read_to'=>0])->count()}}
                                            </h3>
                                ...
                                <div class="col-md-3 col-sm-4 col-6">
                                    <a href="{{route('user.reviews')}}" class="card UserBox TopBoxs mb-4">
                                        <div class="card-body">
