                ...
                <div class="col-md-9">
                    ...
                    <form action="{{route('user.schedulequeries')}}" enctype="multipart/form-data" method="post" class="card UserBox p-4" style="max-width:820px;margin:0 auto">
                        ...
                        <div class="card-body d-block">
                            <div class="mb-4">
                                <h4 class="thm h5 fw-semibold">1. Tell us about your Startup ?<span class="text-danger">*</span></h4>
                            ...
                            <div class="mb-4">
                                <h4 class="thm h5 fw-semibold">2. What are the major challenges you are facing ?<span class="text-danger">*</span></h4>
                            ...
                            <div class="mb-4">
                                <h4 class="thm h5 fw-semibold">3. What questions do you want to ask to the mentor ?<span class="text-danger">*</span></h4>
                            ...
                            <div class="mb-4">
                                <h4 class="thm h5 fw-semibold">4. Have you previously worked with any mentors or coaches, and if so, what was the experience like ?<span class="text-danger">*</span></h4>
                            ...
                            <div class="d-md-flex">
                                ...
                                <div class="ms-md-2 d-flex align-items-center">
                                    <label class="d-flex align-items-center text-primary AddFile" for="addfile">Add File <i class="fal fa-arrow-to-bottom ms-md-4 ms-2"></i></label>
                            ...
                            <div class="text-end mt-4"><button class="btn btn-thm4">Submit</button></div>
                        </div>
                    </form>
                </div>
            </div>
...
.AddFile{margin-right:-102px;position:relative;background:#e7e8eb;height:100%;padding:5px 15px;border-radius:5px;font-size:15px;white-space:nowrap}
[type=file]::file-selector-button{margin:0 20px 0 0!important}
.ConHR{background:rgb(var(--thmrgb)/.15)!important;border:1px solid rgb(var(--thmrgb)/.1)!important;max-width:450px;width:100%;margin:30px auto 0}</style>
@endpush
@push('js')
<script>
