        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-8">
                    ...
                    <form action="{{route('expertregister')}}"  method="get" class="card card-body formbox mt-3">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 mb-2">
                                <div class="">                                    
                                    <div class="CustomerInfo">
                                        <small class="num text-secondary d-block mb-3 text-center"><span class="thm">1 <i class="fal fa-long-arrow-right"></i></span> Step</small>
                                        <h3 class="h5 thm">What is your full Name? <span class="text-danger">*</span></h3>
                                        <div class="input-group">
                                            <input type="text" class="form-control inputTextBox" value="{{old('name')}}" required name="name" placeholder="Type your answer here...">
