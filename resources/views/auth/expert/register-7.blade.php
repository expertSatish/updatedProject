        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-8">
                    ...
                    <form action="{{route('expert.saveregisteration',['step'=>'s7'])}}" method="post" class="card card-body formbox mt-3">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 mb-2">
                                <div class="CustomerInfo" id="s7">
                                    <small class="num text-secondary d-block mb-3 text-center"><span class="thm">7 <i class="fal fa-long-arrow-right"></i></span> Step</small>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-ms-6">
                                                <div class="RadioBox mb-2">
                                                    <input type="checkbox" class="btn-check language" @checked(in_array($language->id,old('language',$exlang))) name="language[]" value="{{$language->id ?? 0}}" id="lang{{$language->id ?? 0}}" autocomplete="off">
                                    ...
                                    <div class="text-center d-flex justify-content-between align-items-center mt-3">
                                        <a href="{{route('expert.register',['type'=>'s6'])}}" class="btn btn-sm formbtn BackToStep sws-top sws-bounce" data-title=""><i class="fal fa-arrow-left me-2"></i> Back</a>
                                        <button class="btn ms-2 px-4 bg-thm checkstep7 formbtn Next sws-bottom" onclick="$('.checkstep7').hide(); $('.p-checkstep7').show();" data-title="Next"> Next <i class="fal fa-arrow-right"></i></button>
                                        <button type="button" class="btn px-4 bg-thm p-checkstep7 formbtn Next sws-bottom pbtn disabled" style="display:none;" data-title="Next"> <i class="fad fa-spinner-third fa-spin"></i> Loading... </button>
                                    </div>
                                </div>
                            </div>
                        </div>
