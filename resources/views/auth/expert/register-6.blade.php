        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-8">
                    ...
                    <form action="{{route('expert.saveregisteration',['step'=>'s6'])}}" method="post" class="card card-body formbox mt-3">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 mb-2">
                                <div class="CustomerInfo" id="s6">
                                    <small class="num text-secondary d-block mb-3 text-center"><span class="thm">6 <i class="fal fa-long-arrow-right"></i></span> Step</small>
                                    <h3 class="h5 thm">What is your current Industry? <span class="text-danger">*</span></h3>
                                    <div class="ListBox LBorder mt-2 w-100">
                                        <div class="row">
                                            @foreach($Industries as $Industry)
                                            <div class="col-lg-6">
                                                <div class="RadioBox mb-2">
                                                    <input type="checkbox" class="btn-check industry" @checked(in_array($Industry->id ?? 0,old('industry',$exind))) name="industry[]" value="{{$Industry->id ?? 0}}" id="ind{{$Industry->id ?? 0}}" autocomplete="off">
                                    ...
                                    <div class="text-center d-flex justify-content-between align-items-center mt-3">
                                        <a href="{{route('expert.register',['type'=>'s5'])}}" class="btn btn-sm formbtn BackToStep sws-top sws-bounce" data-title=""><i class="fal fa-arrow-left me-2"></i> Back</a>
                                        <button class="btn ms-2 px-4 checkstep6 bg-thm formbtn Next sws-bottom" onclick="$('.checkstep6').hide(); $('.p-checkstep6').show();" data-title="Next"> Next <i class="fal fa-arrow-right"></i></button>
                                        <button type="button" class="btn px-4 bg-thm p-checkstep6 formbtn Next sws-bottom pbtn disabled" style="display:none;" data-title="Next"> <i class="fad fa-spinner-third fa-spin"></i> Loading... </button>
                                    </div>
                                </div>
                            </div>
                        </div>
