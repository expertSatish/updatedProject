                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($booking->coupon_discount > 0)
                                                                <small class="d-block">Discount: <b>&#8377;
                                                                        {{ $booking->coupon_discount ?? '0' }}</b></small>
                                                            @endif
                                                            @if ($booking->gst > 0)
                                                                <small class="d-block">GST({{ $booking->gst }}%):
                                                                    <b>&#8377;
                                                                        {{ $booking->gst_amount ?? '0' }}</b></small>
                                                            @endif
                                                        ...
                                                        <td>
                                                            @if ($booking->payment == 0)
                                                                <small class="text-secondary"><i class="fad fa-circle"
                                                                        style="font-size: 10px;"></i> Incomplete
                                                                    Process</small>
                                                            @endif
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{ route('expert.scheduleinfo', ['booking' => $booking->booking_id]) }}"
                                                                ...
                                                                data-title="Slot Information"> <i class="fas fa-book"></i>
                                                            </a>

                                                            @if ($booking->status == 0)
                                                                <a href="{{ route('expert.scheduleconfirm', ['confirm' => 1, 'schedule' => $booking->id]) }}"
                                                                    class="btn btni btn-primary sws-left sws-bounce"
                                                                    data-title="Confirm Schedule"><i
                                                                        class="fal fa-calendar-check"></i><span
                                                                        class="ms-md-1"></span></a>
                                                            @endif
                                                            ...
                                                            @if (!empty($booking->call_recording_id))
                                                                <a href="#DownloadRecording"
                                                                    ...
                                                                    class="btn btni btn-primary sws-left sws-bounce"
                                                                    data-bs-toggle="modal" data-title="Download Recording">
                                                                    ...
                                                                    @if ($booking->status == 1 && $booking->reschedule_slot == 0)
                                                                        ...
                                                                        @if (date('Y-m-d H:i') >= $Start && date('Y-m-d H:i') <= date('Y-m-d H:i', strtotime('+10 minutes' . $End)))
                                                                            <a href="{{ route('expert.videocall', ['schedule' => $booking->booking_id]) }}"
                                                                                class="btn btni btn-success sws-top sws-bounce"
                                                                                data-title="Invite & Start Call"><i
                                                                                    class="fas fa-phone-volume"></i></a>
                                                                        @endif
                                                                        <button
                                                                            class="SendMessage btn btni btn-warning sws-top sws-bounce"
                                                                            type="button" data-title="Message"><i
                                                                                class="fal fa-comment-alt-lines"></i></button>
                                                                        @if ($booking->call_invitation == 0)
                                                                            ...
                                                                            <a href="#rejected" data-bs-toggle="modal"
                                                                                ...
                                                                                class="btn btni btn-danger sws-left sws-bounce"
                                                                                data-title="Reject Schedule"><i
                                                                                    class="fal fa-vote-nay"></i></a>
                                                                        @endif
                                                                    @endif
                                        ...
                                        @foreach ($bookings as $booking)
                                            <div class="Tbody">
                                                ...
                                                <div class="cell">
                                                    ...
                                                    @endif
                                                    @if ($booking->payment == 1 || $booking->payment == 3)
                                                        @if ($booking->reschedule_slot == 0 && $booking->call_invitation == 0)
                                                            <a href="#ChangeSchedulCall"
                                                                onclick="$('input[name=bookingid]').val({{ $booking->id }});"
                                                ...
                                                <div class="cell">
                                                    @if ($booking->reschedule_slot == 0 && $booking->status == 1)
                                                        @php
                                                            $Start = date('Y-m-d H:i', strtotime('-60 minutes' . $booking->booking_date . ' ' . $booking->booking_start_time));
                                                            $End = $booking->booking_date . ' ' . $booking->booking_end_time;
                                                        @endphp
                                                        @if (date('Y-m-d H:i') >= $Start && date('Y-m-d H:i') <= date('Y-m-d H:i', strtotime('+10 minutes' . $End)))
                                                            <a href="{{ route('expert.videocall', ['schedule' => $booking->booking_id]) }}"
                                                                class="h5 text-primary">Session Link</a>
                                                        @else
                                                            --------
                                                        @endif
                                                    @else
                                                ...
                                                <div class="cell text-end">
                                                    @if ($booking->reschedule_slot == 0)
                                                        <button class="SendMessage small sbtn" type="button"
                                                            ...
                                                            data-title="Message"><i class="fal fa-comment-alt-lines"></i>
                                                            Message</button>
                                                    @endif
                                                    <a href="{{ route('expert.scheduleinfo', ['booking' => $booking->booking_id]) }}"
                                                    ...
                                                    <a href="{{ route('expert.questionnaire', ['booking' => $booking->booking_id]) }}"
                                                        class="small sbtn"><i class="far fa-info-circle"></i>
                                                        Questionnaire
