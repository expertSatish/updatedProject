<?php
   ...
   $posted = array(
       ...
       'productinfo' => 'Deposit Money',
       'surl' => url('depositpayu-success/'.$data->transationno.'?userinfo='.userinfo()->user_id),
       'furl' => url('depositpayu-failed/'.$data->transationno.'?userinfo='.userinfo()->user_id),
