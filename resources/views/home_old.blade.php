                ...
                <div class="container">
                    ...
                    <div class="row wow slideIn">
                        @foreach ($findexpertcategories as $item)
                            <div class="col-lg-3 col-sm-6 mb-md-4 mb-2">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-7 wow slideIn">
                        ...
                        <div class="text-center text-md-start"><a href="{{ route('becomeanexpert') }}" class="btn btn-thm4 btn-lg mt-4 mb-4">Become an Mentor</a></div>
                    </div>
