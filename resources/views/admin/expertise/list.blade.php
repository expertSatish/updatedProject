                ...
                <div class="col-sm-5">
                    ...
                    <div class="card shadow-base bd-0">
                        ...
                        <div class="card-body justify-content-between align-items-center">
                            ...
                            <form method="post" action="{{ route('admin.expertise.save') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mg-b-25">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Catgeory <span class="error">*</span></label>
                                            ...
                                            @foreach ($lists as $list)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $list->title }}
                                                        <br>
                                                        <small class="text-primary"><b>CATEGORY: </b> {{ $list->category->title ?? '------' }}</small>
                                                    </td>
                                                    ...
                                                    <td class="pd-r-0-force tx-center">
                                                        ...
                                                        <div class="dropdown TAction show">
                                                            ...
                                                            <ul class="dropdown-menu" x-placement="bottom-end">
                                                                ...
                                                                <li><a href="{{ route('admin.expertise.remove', ['id' => $list->id]) }}"
                                                                        class="text-danger"
...
@push('js')
    ...
    <script>
        ...
        $('.sequenceform').on('click', function() {
            $('.table-wrapper').attr('action', @json(route('admin.expertise.sequence')));
            $('.table-wrapper').submit();
        });
        $('.bulkremoveform').on('click', function() {
            $('.table-wrapper').attr('action', @json(route('admin.expertise.bulkremove')));
            $('.table-wrapper').submit();
        });
