                    ...
                    <div class="card shadow-base bd-0">
                        ...
                        <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                            ...
                            <form action="{{ url()->current() }}" class="tx-12 searfrm tx-uppercase d-flex">
                                ...
                                <a href="{{ url()->current() }}" class="btn btn-dark ms-2"><i
                                                    ...
                                                    <td class="pd-r-0-force tx-center">
                                                        ...
                                                        <div class="dropdown TAction show">
                                                            ...
                                                            <ul class="dropdown-menu" x-placement="bottom-end">
                                                                ...
                                                                <li><a
                                                                    href="{{ route('admin.experts.videos', ['id' => $list->id]) }}"><i class="fa fa-video-camera"></i> Introduction Video</a>
                                                                </li>
                                                                <li><a href="#slotcharges"
                                                                        data-slot-expert="{{ $list->id }}"
                                                                        data-toggle="modal">
                                                                        <i class="fa fa-calculator"></i> Slot Charges
                                                                    </a>
                                                                </li>
                                                                <li><a href="#servicecharges"
...
@push('js')
    ...
    <div id="servicecharges" class="modal fade">
        <div class="modal-dialog" role="document">
            <form method="POST" action="{{ route('admin.experts.expertservicecharges') }}"
    ...
    <div id="couponCode" class="modal fade">
        <div class="modal-dialog" role="document">
            <form method="POST" action="{{ route('admin.experts.couponCode') }}"
                class="modal-content bd-0 tx-14">
                @csrf
                <input type="hidden" name="expertid">
                <div class="col-lg-12 form-group">
                      ...
                      <div class="col-lg-12 form-group">
                        ...
                        <input type="text" class="form-control" name="percentage" onkeypress="return isNumberKey(event);" placeholder="Percentage"  required>
                      </div>
                      <div class="col-lg-12 form-group">
