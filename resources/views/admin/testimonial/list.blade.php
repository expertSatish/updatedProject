                                ...
                                <th class="wd-5p">
                                    <div class="dropdown TAction show">
                                        <a href="#" class="nav-link p-0 w-auto text-white text-center"
                                            data-toggle="dropdown" aria-expanded="true"><i class="fa fa-ellipsis-v"></i></a>
                                        <ul class="dropdown-menu" x-placement="bottom-end">
                                            <li><a href="javascript:void(0)"
                                                    onclick="$('.bannerform').attr('action','{{ route('admin.testimonialsequence') }}'); $('.bannerform').submit();"><i
                                                        class="fa fa-sitemap"></i> Update Sequence</a>
                                            </li>
                                            <li><a href="javascript:void(0)"
                                                    onclick="$('.bannerform').attr('action','{{ route('admin.bulkdestorytestimonial') }}');  $('.bannerform').submit();"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" @checked($list->is_publish) type="checkbox"
                                                value="{{ $list->id }}" role="switch"
                                    ...
                                    <td class="pd-r-0-force tx-center">
                                        ...
                                        <div class="dropdown TAction show">
                                            ...
                                            <ul class="dropdown-menu" x-placement="bottom-end">
                                                ...
                                                <li><a href="{{ route('admin.edittestimonial', ['id' => $list->id]) }}"><i
                                                            class="fa fa-pencil"></i> Edit</a></li>

                                                <li><a href="{{ route('admin.removetestimonial', ['removeid' => $list->id]) }}"
