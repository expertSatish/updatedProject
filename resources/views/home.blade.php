...
<main class="HomePage">
                    ...
                    <div class="MBox mt-5 pt-5 text-center">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <a href="{{ route('experts') }}" class="btn btn-thm btn-lg">Browse Mentor
                                    <!--<img src="{{ asset('frontend/img/arrow.svg') }}" alt="arrow" class="ms-3" width="30" height="30">-->
                                </a>
                            </div>
                        </div>
                        <div id="carouselSlide" class="carousel VideoBox slide wow zoomIn" data-bs-ride="carousel">
                            ...
                            <div class="carousel-item h-100 w-100 lh-0 {{$loop->iteration==1?'active':''}}">
                                ...
                                @if ($item->type == 'video')
                                <!-- <button class="playbtn play"><span></span></button> -->
                                <video id="PVideo" loading="lazy" autoplay muted loop playsinline preload="metadata">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-5 wow slideIn">
                    ...
                    <div class="text-center text-lg-start mb-4"><a href="{{ route('experts') }}"
                            class="btn btn-thm3 btn-lg">Browse Mentor</a></div>
                </div>
                            ...
                            <div class="card ExpBlock verify">
                                ...
                                <a href="{{ route('experts', ['alias' => $expert->user_id]) }}" class="card-body">
                                    <div>
                                        ...
                                        @if (!empty($expertise->expertiseinfo) && $loop->iteration < 3) <small
                                            class="bg-warning rounded-1 d-inline-block text-black mb-2">
                                    ...
                                    <div class="ExpCon">
                                        ...
                                        <small class="text-white fw-lighter">
                                            ...
                                            @if (!empty($roles->roleinfo) && $loop->iteration < 3)
                                                {{ $roles->roleinfo->title }} {{ $loop->iteration < 1 ? ', ' : '' }}
    ...
    <section class="Sec7">
        <div class="container">
                ...
                <div class="col-lg-3 col-sm-6 mb-md-4 mb-2 d-none">
                    <div class="card mx-lg-4 text-center">
                        <div class="card-body">
                            ...
                            <div class="cats">
                                @foreach ($item->expertise as $exp)
                                <a href="{{route('expertcategory',$item->alias)}}/{{$exp->alias??''}}"
                                    class="rounded-5 p-1 px-3 d-inline-block text-black">{{ $exp->title ?? '' }}</a>
                                @endforeach
                            </div><br>
            ...
            <div class="text-center text-lg-end mt-5"><a href="{{ route('experts') }}" class="h5 thm4">View More <i
    ...
    <div class="col-12">
        <div class="owl-carousel">
            ...
            <img loading="lazy" src="{{ asset($path . $image) }}" class="{{$class ?? ''}}" id="{{ $id ?? '' }}"
            ...
            <picture class="{{$pictureclass ?? ''}}">
                ...
                <img loading="lazy" src="{{ asset($path . 'jpg/'. $image . '.jpg') }}" id="{{ $id ?? '' }}"
                    class="{{$class ?? ''}}" alt="{{$alt ?? ''}}" width="{{$width ?? ''}}" height="{{$height ?? ''}}">
            </picture>
            ...
            <picture>
                ...
                <img loading="lazy" src="{{ asset('frontend/image/no-img.jpg') }}" id="{{ $id ?? '' }}"
                    class="{{$class ?? ''}}" alt="{{$alt ?? ''}}" width="{{$width ?? ''}}" height="{{$height ?? ''}}">
            </picture>
            @endif
            @endforeach
    ...
    <section class="Testimonial d-none d-md-block">
        <div class="container">
            <div class="row wow slideInDown">
                <div class="col-12">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-sm-7 wow slideIn">
                    ...
                    <div class="text-center text-md-start"><a href="{{ route('becomeanexpert') }}"
                        ...
                        <div class="item">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="play"></div>
                                    @endif
                                    <a href="{{route('experts',['alias'=>$video->expert->user_id,'type'=>'videos','v'=>$video->video_id,'check'=>Request::segment(2)])}}"
                                        class="playVideo"></a>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header" id="Pay{{ $loop->iteration }}">
                                <button class="accordion-button {{ $loop->iteration == 1 ? '' : 'collapsed' }}"
                                    type="button" data-bs-toggle="collapse" data-bs-target="#Faqs{{ $loop->iteration }}"
                                    aria-expanded="true" aria-controls="Faqs1">{{ $faq->title }}</button>
                            </div>
    ...
    {!! $bannercms->description !!}
    <a href="{{ route('experts') }}" class="btn btn-thm btn-lg">Browse Mentor
        <!--<img src="{{ asset('frontend/img/arrow.svg') }}" alt="arrow" class="ms-3" alt="arrow" width="30" height="30">-->
    </a>
    </div>
    </div>
    <div id="carouselSlide" class="carousel VideoBox slide wow zoomIn" data-bs-ride="carousel">
        ...
        @endforeach
        @if($banners->count()>1)
        <button class="carousel-control-prev" type="button" data-bs-target="#carouselSlide" data-bs-slide="prev"><span
                class="carousel-control-prev-icon" aria-hidden="true"></span><span
                class="visually-hidden">Previous</span></button>
        <button class="carousel-control-next" type="button" data-bs-target="#carouselSlide" data-bs-slide="next"><span
    ...
    <a href="{{url('become-an-expert')}}" class="btn btn-thm btn-lg">Become an Expert <img
            src="{{ asset('frontend/img/arrow.svg') }}" alt="arrow" class="ms-3" width="30" height="30"></a>
    </div>
    </div>
    </div>
    </section> --}}
...
<meta name="description"
    content="Improve your skills and reach your personal goals with the world class mentors. Find a right mentor and consultant for your startups and entrepreneurs. Start your journey today!">
