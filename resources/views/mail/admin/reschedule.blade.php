...
<p>new reschedule booking is #{{$body['booking']['booking_id']}} on {{date('d M Y',strtotime($body['booking']['booking_date']))}} at {{date('H:i A',strtotime($body['booking']['booking_start_time']))}} To {{date('H:i A',strtotime($body['booking']['booking_end_time']))}}.</p><br>
