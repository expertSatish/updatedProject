...
class SocialController extends Controller
{
    ...
    */
    ...
    {
        session()->put('state', $request->input('state'));
      $user =   $user = Socialite::driver('facebook')->user();
	 ...
	 // print_r($authUser);exit;
	  ...
	  else
	  {
		...
		'facebook_id' => $authUser['social_id'],
		'status' => 1, 
	...
	public function findOrCreateUser($user)
    {
		...
		'random_data' => $random_data,
         ...
         $authUser=array('name'=>$user->name,'email'=>$user->email,'social_role'=>'facebook','random_data'=>$random_data,'social_id'=>$user->id,'email_verification_status'=>0);
