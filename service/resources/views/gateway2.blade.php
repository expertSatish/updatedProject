...
<body>
  ...
  <form action="<?php echo $action; ?>" method="post" name="payuForm">
    ...
    <input type="hidden" name="firstname" id="fname" value="{{$data->name}}" />
    <input type="hidden" name="email" id="email" value="{{$data->email}}" />
    <input type="hidden" name="phone" id="phone" value="{{$data->contact}}" />
    <textarea style="display: none;" id="pinfo" name="productinfo">{{$data->message}}</textarea>
