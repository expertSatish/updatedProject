          ...
          <div class="x_panel">
            ...
            <div class="x_title">
             ...
             @if($flag)   
                ...
                <h2>Update Pre Requirements Management</h2>

                {!! Helper::BackBtn(url('control-panel/pre-requirements/'.$array_data->category_id)) !!}

             @else

                

                <h2>New Pre Requirements Management</h2>

                {!! Helper::BackBtn(url('control-panel/pre-requirements/'.Request::segment(3))) !!}
            ...
            <div class="x_content">
              ...
              <div class="modal-body">
                ...
                <form action="{{url('control-panel/save-pre-requirements')}}" id="demo-form2" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" >
                ...
                @else    
                   ...
                   <form action="{{url('control-panel/edit-pre-requirements/'.$array_data->id)}}" id="demo-form2" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" > 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="Details[]" class="form-control">@if($flag){{$array_data->text}}@endif</textarea>
...
<script>
  ...
  function validation(){
...

      {
         ...
         if($('#Description'+A).val()==''){ Description=1; }
