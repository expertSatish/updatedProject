                ...
                <div class="col-md-12">
                  <table id="datatable1" class="table table-striped table-bordered bulk_action">
                    ...
                    <tr>
                      ...
                      <td>{{$i->subject}}</td>
                      <td>{{$i->message}}</td>
                      <td><a href="{{asset('/resources/assets/uploads/career/'.$i->file)}}" download target="_blank">Download</a></td>
                      <td>
                        <a href="{{url('control-panel/career-enquiry-remove/'.$i->career_enquiry_id)}}" onclick="return confirm('Are you sure? Want to delete?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Remove</a>
                      </td>
