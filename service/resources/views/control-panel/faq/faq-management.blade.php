          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                ...
                <a href="{{url('control-panel/new-faq/'.Request::segment(3))}}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New </a>
              ...
              <div class="x_content">
                ...
                <form action="{{url('control-panel/remove-faq')}}" method="post">
                  {{csrf_field()}}
                  ...
                  <table id="datatable1" class="table table-striped table-bordered bulk_action">
                    ...
                    <tr>
                      ...
                      <td>{{$Rows->title}}</td>
                      <td>{!! Helper::CheckDataStatus(url('control-panel/faq-status'),$Rows->id,$Rows->status) !!}</td>

                      <td>

                        {!! Helper::EditBTN(url('control-panel/update-faq/'.$Rows->id)) !!}
