      ...
      <div class="right_col" role="main">
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2 class="pull-left">Add Coupon</h2>
              ...
              <div class="x_content">
                <div class="row">
                  <div class="col-lg-12">
                    <form action="{{url('/control-panel/coupon-save')}}" method="post">
                      @csrf
                      ...
                      <div class="col-lg-6 form-group">
                        ...
                        <input type="text" class="form-control" name="percentage" onkeypress="return isNumberKey(event);" placeholder="Percentage" value="{{old('percentage')}}" required>
                      </div>
                      <div class="col-lg-6 form-group">
                        <label>Start Date</label>
                        <input type="text" class="form-control datepicker" placeholder="Select date" name="start_date" value="{{old('start_date')}}" readonly>
                      </div>
                      <div class="col-lg-6 form-group">
                        <label>End Date</label>
                        <input type="text" class="form-control datepicker" placeholder="Select date" name="end_date" value="{{old('end_date')}}" readonly>
                      </div>
