  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="x_panel">
      ...
      <div class="x_title">
        ...
        <h2>Update Gallery Management </h2>

           

          <a href="{{url('control-panel/product-gallery/'.$data->service_id)}}"  class="btn btn-danger pull-right" ><i class="fa fa-arrow-left"></i> Back</a>
    ...
    <form method="post" action="{{url('control-panel/edit-product-gallery')}}" enctype="multipart/form-data">
