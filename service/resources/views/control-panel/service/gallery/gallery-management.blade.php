    ...
    <div class="x_panel">
      ...
      <div class="x_title">
        ...
        <h2>Gallery Management </h2>
          ...
          <a href="{{url('control-panel/update-cms/'.Request::segment(3))}}" class="btn btn-danger pull-right" ><i class="fa fa-backward"></i> Back</a>
          ...
          <tbody>
            ...
            @foreach($arr_data as $data)
                ...
                @if($data->type=='image')
                    ...
                    <td> <img src="{{asset('resources/assets/uploads/service-gallery/'.$data->title)}}" width="20%"> </td>
                ...
                @endif   
                    ...
                    <td> {!!  $Btn  = Helper::CheckDataStatus( url('/control-panel/product-gallery-status/') , $data->id , $data->status ); !!}  </td>

                    <td>

                        <a href="{{url('control-panel/update-product-gallery/'.$data->id)}}" class="btn btn-info btn-xs" ><i class="fa fa-pencil"></i> Edit</a>

           

                        {!!  $Btn = Helper::HRFRemoveBTN( url('/control-panel/product-gallery-remove/'.$data->id)); !!}
...
<div id="AddModal" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <form method="post" action="{{url('control-panel/save-product-gallery')}}" enctype="multipart/form-data">
