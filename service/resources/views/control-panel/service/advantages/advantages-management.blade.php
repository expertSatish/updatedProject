                  ...
                  <table id="datatable" class="table table-striped table-bordered bulk_action">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <img src="{{asset('resources/assets/uploads/service-gallery/'.$data->title)}}"> </td>

                        <td> {{$data->alt}} </td>

                        <td> {!! $Btn = Helper::CheckDataStatus( url('/control-panel/advantages-status/') , $data->id , $data->status ); !!} </td>

                        <td>

                          <a href="{{url('control-panel/update-advantages/'.$data->id)}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit</a>



                          {!! $Btn = Helper::HRFRemoveBTN( url('/control-panel/advantages-remove/'.$data->id)); !!}
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add Advantages</h4>

      </div>



      <form method="post" action="{{url('control-panel/save-advantages')}}" enctype="multipart/form-data">
