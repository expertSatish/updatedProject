          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                ...
                <a href="http://127.0.0.1/Laravel/expertbells/control-panel/heading-edit/3" data-toggle="modal" class="btn btn-warning pull-right"><i class="fa fa-pencil"></i> Heading Section</a>
                  ...
                  <table id="datatable" class="table table-striped table-bordered bulk_action">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> {!! $Btn = Helper::CheckDataStatus( url('/control-panel/why-choose-us-status/') , $data->id , $data->status ); !!} </td>

                        <td>

                          <a href="{{url('control-panel/update-why-choose-us/'.$data->id)}}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit</a>



                          {!! $Btn = Helper::HRFRemoveBTN( url('/control-panel/why-choose-us-remove/'.$data->id)); !!}
...
<div id="AddModal" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      ...
      <form method="post" action="{{url('control-panel/save-why-choose-us')}}" enctype="multipart/form-data">
