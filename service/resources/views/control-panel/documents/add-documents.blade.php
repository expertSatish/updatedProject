          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_title">
                ...
                <h2>Update Documents Management</h2>

                {!! Helper::BackBtn(url('control-panel/documents/'.$array_data->category_id)) !!}

                @else



                <h2>New Documents Management</h2>

                {!! Helper::BackBtn(url('control-panel/documents/'.Request::segment(3))) !!}
              ...
              <div class="x_content">
                ...
                <div class="modal-body">
                  ...
                  <form action="{{url('control-panel/save-documents')}}" id="demo-form2" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                    ...
                    <form action="{{url('control-panel/edit-documents/'.$array_data->id)}}" id="demo-form2" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6">
                          ...
                          <textarea name="Details[]" class="form-control" id="Description1">@if($flag){{$array_data->text}}@endif</textarea>
