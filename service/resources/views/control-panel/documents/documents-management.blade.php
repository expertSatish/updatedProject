          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                ...
                <a href="{{url('control-panel/new-documents/'.Request::segment(3))}}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New </a>
              ...
              <div class="x_content">
                ...
                <form action="{{url('control-panel/remove-documents')}}" method="post">
                  {{csrf_field()}}
                  ...
                  <table id="datatable1" class="table table-striped table-bordered bulk_action">
                    ...
                    <tr>
                      ...
                      <td>{{$Rows->title}}</td>
                      <td>{{$Rows->text}}</td>
                      <td>{!! Helper::CheckDataStatus(url('control-panel/documents-status'),$Rows->id,$Rows->status) !!}</td>

                      <td>

                        {!! Helper::EditBTN(url('control-panel/update-documents/'.$Rows->id)) !!}
