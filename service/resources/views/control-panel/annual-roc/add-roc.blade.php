          ...
          <div class="x_panel">
            ...
            <div class="x_title">
             ...
             @if($flag)   
                ...
                <h2>Update Annual Roc Management</h2>

                {!! Helper::BackBtn(url('control-panel/annual-roc/'.$array_data->category_id)) !!}

             @else

                

                <h2>New Annual Roc Management</h2>

                {!! Helper::BackBtn(url('control-panel/annual-roc/'.Request::segment(3))) !!}
            ...
            <div class="x_content">
              ...
              <div class="modal-body">
                ...
                <form action="{{url('control-panel/save-annual-roc')}}" id="demo-form2" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" >
                ...
                @else    
                   ...
                   <form action="{{url('control-panel/edit-annual-roc/'.$array_data->id)}}" id="demo-form2" method="post" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" > 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5" style="display: none;">
                        ...
                        <input type="text" name="Currency[]" id="Title1" placeholder="Enter Title." value="@if($flag){{$array_data->title}}@endif" class="form-control string">
...
<script>
...

  {
     ...
     var NewNum = parseInt(BoxNum) + parseInt(1); 
       ...
       $('.morebox').append('<div class="form-group" id="box'+NewNum+'" style="margin-top:5px;"><div class="col-md-5" style="display:none;"><label class="control-label" for="first-name">Title </label><input type="text" name="Currency[]" id="Title'+NewNum+'" placeholder="Enter Title." class="form-control string"></div><div class="col-md-11"><label class="control-label" for="first-name">Description <span class="text-danger required">*</span> </label><textarea class="form-control" name="Details[]" id="Description1'+NewNum+'"></textarea></div><div class="col-md-1" style="margin-top: 26px;"><button onclick="RemoveMoreBox('+NewNum+');" class="btn btn-danger" type="button"><i class="fa fa-trash"></i></button></div></div>');

      

       CKEDITOR.replace( 'Description1'+NewNum );
  ...
  function validation(){
      ...
      for(var A=1;A<=BoxCo;A++){
        if($('#Title'+A).val()==''){ Title=1; }
        var DescriptionData =  CKEDITOR.instances['Description1'+A].getData();
        
        alert(DescriptionData);
        if(DescriptionData==''){ Description=1; }
