          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                ...
                <a href="{{url('control-panel/new-annual-roc/'.Request::segment(3))}}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New </a>
              ...
              <div class="x_content">
                ...
                <form action="{{url('control-panel/remove-annual-roc')}}" method="post">
                  {{csrf_field()}}
                  ...
                  <table id="datatable1" class="table table-striped table-bordered bulk_action">
                    ...
                    <tr>
                      ...
                      <td>{{$Rows->text}}</td>
                      <td>{!! Helper::CheckDataStatus(url('control-panel/annual-roc-status'),$Rows->id,$Rows->status) !!}</td>

                      <td>

                        {!! Helper::EditBTN(url('control-panel/update-annual-roc/'.$Rows->id)) !!}
