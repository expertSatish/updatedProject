var boltDomainName = null,
    ...
    ICPconfTemp = null,
    boltMob =
        (!/(tablet|ipad|playbook|PAD)|(android(?!.*(mobi|opera mini)))/i.test(navigator.userAgent) &&
    ...
    bolt_purchase_from = (function () {
        switch (bolt_purchase_from) {
            ...
            case "PAYUMONEY_SELFPAY":
                ...
                break;
            case "GIFTCARD_ISSUANCE":
                bolt_giftCard = !0;
                isBoltEnabledParam = "purchaseFrom\x3dGIFTCARD_ISSUANCE" + isBoltEnabledParam;
                bolt_purchase_from = "GIFTCARD_ISSUANCE";
                break;
            default:
...
(function () {
    function b(b) {
        ...
        d.onreadystatechange = function () {
            ...
            var b = navigator.userAgent || navigator.vendor || window.opera,
                n = -1 < b.indexOf("Instagram") ? !0 : !1,
                b = -1 < b.indexOf("FBAN") || -1 < b.indexOf("FBAV") ? !0 : !1;
            if (d.readyState == XMLHttpRequest.DONE && 200 == d.status) {
                try {
                    !JSON.parse(d.responseText) || n || b || (bolt_switch = !0);
                } catch (m) {}
                g(bolt_switch);
            }
    ...
    function g(b) {
        b && boltPrefetcher();
        bolt_invoice && "function" === typeof initiateBolt && initiateBolt(bolt_switch);
    }
    ...
    boltPrefetcher = function () {
        ...
        d.onreadystatechange = function () {
            if (d.readyState == XMLHttpRequest.DONE && 200 == d.status) {
                ...
                h.src = b;
                h.id = "loadIframe";
                h.setAttribute("style", "display:none;position:fixed;width:0%;height:0%;left:0;bottom:0;overflow:hidden;");
    ...
    bolt_invoice || bolt_event || bolt_button || bolt_webfront || bolt_webstore || bolt_payunow || bolt_sidynamic || bolt_sibutton || bolt_selfpay || bolt_giftCard
        ? isBoltEnabledParam
...
var bolt = (function () {
    ...
    Array.prototype.indexOf = function (b, d) {
        for (var g = d || 0, m = this.length; g < m; g++) if (this[g] === b) return g;
        return -1;
    };
    return {
        launch: function (h, n) {
            ...
            function C() {
                ...
                if (isBoltCached && b && JSON.stringify(ICPconfTemp) === JSON.stringify(h)) a = ICPconfTemp;
                else {
                    var a = D();
            ...
            function E() {
                ...
                if (a) (b.style.display = "block"), (a.style.display = "block");
                    ...
                    var f = document.body,
                        ...
                        k = Math.max(f.scrollHeight, f.offsetHeight, k.clientHeight, k.scrollHeight, k.offsetHeight),
                        f = document.createElement("div");
                    f.id = "icpLoader";
                    boltMacOs
                        ? f.setAttribute("style", "height:" + k + "px;display:block;position:absolute;width:100%;top:0;z-index:10000;overflow:hidden;background:rgba(0, 0, 0, 0.6);")
                    ...
                    k.setAttribute(
                        "style",
                        "height:" + screen.height + "px;display:block;position:fixed;width:100%;left:0;z-index:10000;overflow:hidden;background:url(" + boltDomainName + "/static/kiwi/images/oval.svg) center 45% no-repeat;"
                    );
                    f.appendChild(k);
            ...
            function D() {
                for (
                        ...
                        b =
                            bolt_invoice || bolt_event || bolt_button || bolt_webfront || bolt_webstore || bolt_payunow || bolt_sidynamic || bolt_sibutton || bolt_selfpay || bolt_giftCard
                                ? bolt_invoice
                                    ...
                                    : bolt_event
                                    ? f
                                    : bolt_button || bolt_webfront || bolt_webstore || bolt_payunow || bolt_sidynamic || bolt_sibutton || bolt_selfpay || bolt_giftCard
                                    ? g
                                    : b
                                : b,
                        c = {
                            ...
                            amount: function (a) {
                                return { flg: /(^\d+\.\d*$)|(^\d*\.\d+$)|(^\d+\.\d+$)|(^\d+$)/.test(a), msg: "should be numeric" };
                            },
                    ...
                    if (b[f] in h) {
                        if (((d = c[b[f]]), (d = d(h[b[f]])), !d.flg)) return q(b[f] + ": " + d.msg), (a = !1);
            ...
            function u(a) {
                ...
                "PayuMoneyButton" != ICPconfTemp.purchaseFrom && "PAYUNOW_WEBSITE" != ICPconfTemp.purchaseFrom && "webfront" != ICPconfTemp.purchaseFrom && "webstore" != ICPconfTemp.purchaseFrom && delete ICPconfTemp.purchaseFrom;
                ...
                switch (c) {
                    case "bolt-close":
                        ...
                        boltPayId = null;
                        r();
                        if (d) v(), ((boltiOS && boltMob) || boltiPad) && w(), y(a);
                        else {
                            var f = "",
                                f = "SUCCESS" == a.txnStatus ? (a.surl ? a.surl : a.postUrl) : a.furl ? a.furl : a.postUrl;
                            "" == f || f.startsWith("http") || (f = "http://" + f);
                            c = document.createElement("form");
                            c.setAttribute("method", "GET");
                            c.setAttribute("action", f);
                            for (var k in a) (f = document.createElement("input")), f.setAttribute("type", "hidden"), f.setAttribute("name", k), f.setAttribute("value", a[k]), c.appendChild(f);
                    ...
                    case "bolt-cancel":
                        ...
                        ((boltiOS && boltMob) || boltiPad) && w();
                        y(a);
                        z(x, u, !1);
                        break;
                    case "bolt-launched":
                        if (b && ((b.style.visibility = "visible"), m && (m.style.display = "none"), b.contentWindow))
                            try {
                    ...
                    case "bolt-previous-id":
                        try {
                            boltPayId && b.contentWindow.postMessage({ evt: "new", id: boltPayId }, "*");
                        } catch (l) {}
                }
            }
            function F() {
            ...
            function y(a) {
                n && n.responseHandler && n.responseHandler({ response: a });
            }
            function q(a) {
                n && n.catchException && n.catchException({ message: a });
            }
            function r() {
                b = document.getElementById("boltFrame");
                s(b);
            ...
            if (boltSupported) q("Sorry ! This browser is not supported. Please choose another.");
                ...
                var c = C();
                if (c.ICPconf)
                    if ((h.noLoader || E(), c.isBoltCached && b && !bolt_invoice)) {
                        if ((boltiOS && boltMob) || boltiPad) window.scrollTo(0, 0), A();
                        ...
                        if (bolt_invoice || bolt_event || bolt_button || bolt_webfront || bolt_webstore || bolt_payunow || bolt_sidynamic || bolt_sibutton || bolt_selfpay || bolt_giftCard)
                            (p = bolt_switch ? "boltFrame" : ""), (c.ICPconf.boltEnabled = JSON.stringify(bolt_switch));
                        ...
                        if (p) {
                            ...
                            "INVOICE" === bolt_purchase_from && document.getElementsByClassName("invoice-main-container")[0] && (l = document.getElementsByClassName("invoice-main-container")[0]);
                            l.appendChild(boltIframe);
                        }
                        var G = boltDomainName + "/payu/icpcheckout/",
                            l = document.createElement("form");
                        l.setAttribute("method", "POST");
                        l.setAttribute("action", G);
                        l.setAttribute("id", "boltForm");
                        l.setAttribute("target", p);
                        for (var t in c.ICPconf)
                            c.ICPconf.hasOwnProperty(t) &&
                                ((p = document.createElement("input")), p.setAttribute("type", "hidden"), p.setAttribute("name", t), p.setAttribute("value", c.ICPconf[t] ? c.ICPconf[t].toString() : ""), l.appendChild(p));
                        document.body.appendChild(l);
                        try {
                            l.submit();
                        } catch (H) {
                            r(), v(), q("Payment processing failed. Please try again later");
                        }
                        if (boltiOS || boltiPad) window.scrollTo(0, 0), A();
            ...
            var c = window.addEventListener ? "addEventListener" : "attachEvent",
                z = window[window.removeEventListener ? "removeEventListener" : "detachEvent"],
                x = "attachEvent" == c ? "onmessage" : "message";
            (0, window[c])(x, u, !1);
        },
